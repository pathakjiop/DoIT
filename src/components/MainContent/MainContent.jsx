...
const MainContent = ({ setShowCalendar, mobileMenuOpen, setMobileMenuOpen }) => {
  ...
  const { searchQuery, setSearchQuery, showSearch, setShowSearch, viewMode, setViewMode, activeSidebar } = useTasks()
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      {/* Header */}
      <header
        className={`p-3 ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-100 bg-white"} border-b flex flex-wrap md:flex-nowrap items-center justify-between px-4 py-2`}
      >
        {/* Mobile Menu Button */}
        <button
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            className={`p-2 ${darkMode ? "text-gray-300 hover:text-gray-100" : "text-gray-500 hover:text-gray-700"}`}
      ...
      {/* Search Filters */}
      {showSearch && showSearchFilters && <SearchFilters />}
